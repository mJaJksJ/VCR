...
{
    private static readonly ILogger Log = Serilog.Log.ForContext<AuthController>();
    ...
    public IActionResult ExecuteAuthorization(string id, [FromBody] AuthRequestContract authRequest)
    {
        ...
        if (operationRequest == null) return new AuthErrorResult(message: "Ошибка авторизации");
